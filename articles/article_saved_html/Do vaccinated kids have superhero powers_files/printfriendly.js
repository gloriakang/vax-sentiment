var PF_VERSION = "2015-12-18-151553381", pfMod = window.pfMod || function(e, t) {
  var i = e.document, n = i.location.protocol, o = {
    ...
    maxImageWidth: 750,
    hosts: {
      cdn: "https:" == n ? "https://d3nekkt1lmmhms.cloudfront.net" : "http://cdn.printnicer.com",
    ...
    setVariables: function() {
      ...
      "production" !== this.config.environment && (o = "?_=" + Math.random()), this.config.urls = {
        js: {
          ...
          core: t.config.hosts.cdn + t.filePath + t.version + "/core.js" + o,
          algo: t.config.hosts.cdn + t.filePath + t.version + "/algo.js" + o
        },
        css: {
          page: t.config.hosts.cdn + t.filePath + t.version + "/main.css" + o
        },
    ...
    detectPlatforms: function() {
      var t = document.styleSheets, i = /wp-content/i, n = /blogger.com/i;
    ...
    isRedirectNecessary: function() {
      try {
        return navigator.userAgent.match(/(iphone|ipod|android|opera.mini)/i) || navigator.userAgent.match(/ipad/i) && !this.userOptions.redirect.disableForiPad || this.browser.isIE && this.browser.version < 8 || this.browser.isIE && e.adsbygoogle || "undefined" != typeof $ && $.jcarousel && this.browser.isIE || this.browser.isIE && this.browser.version < 9 && "skinnytaste.com" === this.config.domains.page ? !0 : !1;
      } catch (t) {
        return c.log(t), !1;
      }
    },
