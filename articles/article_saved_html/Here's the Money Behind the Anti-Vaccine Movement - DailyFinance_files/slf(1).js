...
var ANRDF=1;
var ANSCC="unescape(isSocialNetworkShared()+document.referrer+catmanduLogger()+catmandu_integration_mcc_m(aolTacRef(), document.referrer, '/search.*query=([^&]+)','TACODA_FINANCE_BUSINESS')+aolFrameParams('channel: prop2')).toLowerCase()";
var ANTPUD;
var ANVDT=0;
var CCLOOKUP22='AEMOdailyfinance.com/portfolios/noportfolios|REMNquotes|AHKRus.investcent|AAKP/tools/aol/lifeins|BAGVcalculators/autos|BRETtools/aol/retire|BAKQinsurance/health|DABGvesting/funds|BAHAtools/aol/home|LINVbond|LAGVauto|FINV/aol/stock|BAKPlife-insurance|BAKPinsurance/life|LAKOhome|LAKNauto|BBZNfinancial-news|BINVstock-quotes/|BAGXloans/college|BINVstock-ticker|HINVcharts|BINVmutual-funds|BINVinvestopedia|BAAUcompany-news|BRETretirement|BINVportfolios|BABGmarketwatch|BINVfinancials/|BTCNtechnology|BAGVloans/auto|HAHAhome|BINVretirement|ADYR-retirement-|AINV/thestreet|BINVinvestor|HINVing|AINVinvesting|AAKM/insurance|BINVearnings/|BTCNtech-news|BINVfinance/|BINVquotes/|GINV/|BINVcharts/|BINVlookup/|BINVmarket|BINVstocks|BINVpfhub|BINVbonds|AAAUmoney.aol.com|APFZfinance.aol.com|APFZdailyfinance.com|AJOBemurse.com|APFZcalculators.aol.com|AFIXsocialnetwork:share:facebook:read|TECM|TECI:facebook|UFILgoogleplus|UECKlifestream|UEUMtwitter|UEWTfacebook:like|[FIQok:recommend|UFIWstumbleupon';
...
var ANBYODO='bk';
var ANTPX='[24]';
function aolFrameParams(params){
var buf="";
var url=unescape(document.location.href).toLowerCase().split("html#");
var pairs=new Array();
if(url.length>1){
url=url[1].split("&");
for(u in url){
