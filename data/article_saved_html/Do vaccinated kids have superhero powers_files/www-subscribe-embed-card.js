...
var xa=k.document,ya=xa&&A?ta()||("CSS1Compat"==xa.compatMode?parseInt(ua,10):5):void 0;var C;if(!(C=!B&&!A)){var E;if(E=A)E=9<=Number(ya);C=E}C||B&&wa("1.9.1");A&&wa("9");function za(){var a=document;return p("yt-subscribe-card")?a.getElementById("yt-subscribe-card"):"yt-subscribe-card"}
