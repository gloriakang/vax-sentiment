...
var ub = {};
function vb() {
  0 != wb && (this.fc = Error().stack, xb[this[ea] || (this[ea] = ++fa)] = this)
}
var wb = 0, xb = {};
vb.prototype.va = !1;
...
Ib.prototype.remove = function(a, b, c, d) {
  ...
  var e = this.h[a];
  b = Jb(e, b, c, d);
  return-1 < b ? (Hb(e[b]), z.splice.call(e, b, 1), 0 == e.length && (delete this.h[a], this.$--), !0) : !1
};
function Kb(a, b) {
  var c = b.type;
...
Fc.prototype.add = function(a, b, c) {
  var d;
  a: {
    d = R;
    for(var e in d) {
...
Hc.prototype.normalize = function() {
...
var Kc = new U("SHOUT", 1200), Lc = new U("SEVERE", 1E3), Mc = new U("WARNING", 900), Nc = new U("INFO", 800), Oc = new U("CONFIG", 700), Pc = new U("FINE", 500), Qc = new U("ALL", 0);
m = T.prototype;
m.qa = function(a) {
  this.Q || (this.Q = []);
  this.Q.push(a)
  ...
  if(c) {
    ...
    try {
      ...
      if(u(c)) {
        ...
        var p, s, n = !1;
        try {
          p = c.lineNumber || c.gc || "Not available"
        }catch(l) {
          p = "Not available", n = !0
        }
        try {
...
V.Sb = S;
V.sb = function() {
  return V.w ? Vc("goog.net.XhrIo") : null
};
V.qa = function(a, b) {
  V.w && a && a.qa(b)
};
...
m.send = function(a, b, c, d) {
  ...
  this.wa = !1;
  this.A = !0;
  this.a = this.V ? this.V.ua() : Xc.ua();
  this.oa = this.V ? this.V.ba || (this.V.ba = this.V.Ca()) : Xc.ba || (Xc.ba = Xc.Ca());
  ...
  !(0 <= va(cd, b)) || (d || c) || f.set("Content-Type", "application/x-www-form-urlencoded;charset\x3dutf-8");
  ob(f, function(a, b) {
  ...
  try {
    ed(this), 0 < this.T && (this.ma = C && G(9) && "number" == typeof this.a.timeout && void 0 !== this.a.ontimeout, V.j(this.f, W(this, "Will abort after " + this.T + "ms if incomplete, xhr2 " + this.ma)), this.ma ? (this.a.timeout = this.T, this.a.ontimeout = v(this.eb, this)) : this.la = Zb(this.eb, this.T, this)), V.j(this.f, W(this, "Sending request")), this.ga = !0, this.a.send(a), this.ga = !1
  }catch(h) {
    V.j(this.f, W(this, "Send error: " + h.message)), dd(this, h)
  }
};
function ya(a) {
...
m.abort = function(a) {
  this.a && this.A && (V.j(this.f, W(this, "Aborting")), this.A = !1, this.I = !0, this.a.abort(), this.I = !1, this.Y = a || 7, this.dispatchEvent("complete"), this.dispatchEvent("abort"), gd(this))
};
m.G = function() {
  this.a && (this.A && (this.A = !1, this.I = !0, this.a.abort(), this.I = !1), gd(this, !0));
  $c.Ia.G.call(this)
};
m.Wa = function() {
  this.va || (this.Ba || this.ga || this.I ? hd(this) : this.zb())
};
m.zb = function() {
  hd(this)
};
function hd(a) {
  if(a.A && "undefined" != typeof aa) {
    if(a.oa[1] && 4 == id(a) && 2 == jd(a)) {
      V.j(a.f, W(a, "Local request error detected and ignored"))
    }else {
      if(a.ga && 4 == id(a)) {
        Zb(a.Wa, 0, a)
      }else {
        if(a.dispatchEvent("readystatechange"), 4 == id(a)) {
...
m.get = function(a, b) {
  for(var c = a + "\x3d", d = (this.W.cookie || "").split(qd), e = 0, f;f = d[e];e++) {
...
;var td = new Q(401, "Failed to get response for Ad tag request!"), ud = new Q(402, "Invalid Ad tag response!");
function vd(a, b, c) {
  L.call(this);
  this.M = ma(a);
  a = this.M;
  if(!(0 > a.indexOf("ads.adap.tv"))) {
    var d = new pd(document), e = d.get("migrated");
    b: {
  ...
  this.lb = c;
  this.c = new tc;
  this.f = Vc("adaptv.vpaid.Resolver")
}
x(vd, L);
...
vd.prototype.Ab = function(a) {
  switch(a.type) {
    case "success":
      a = null;
      null !== ld(this.o) ? a = ld(this.o) : null !== kd(this.o) && (a = sd(kd(this.o)));
      a = wd(a);
      this.c.X = this.c.X || a.X;
      Ca(this.c.i, a.i);
      this.o.da();
      (a = a.i[0]) && a.length ? this.pb == this.c.i.length || a[0] instanceof wc ? this.dispatchEvent(new Ic("done", this.c)) : (a = a[0]) && a.na ? (this.M = a.na, this.ka()) : (this.c.error = td, this.dispatchEvent(new Ic("error", this.c))) : (this.c.error = td, this.dispatchEvent(new Ic("error", this.c)));
      break;
    case "error":
      this.o.da();
      this.c.error = td;
      this.dispatchEvent(new Ic("error", this.c));
      break;
    case "timeout":
      this.o.da(), this.c.error = ud, this.dispatchEvent(new Ic("error", this.c))
  }
};
function wd(a) {
  var b = new tc;
  ...
  if(a) {
    ...
    for(var b = 0;b < a.length;b++) {
      ...
      switch(c.nodeName) {
        case "InLine":
          if(b = c) {
            for(a = new wc, a.beacons = new Fc, b = H(b), c = 0;c < b.length;c++) {
              var d = b[c];
              switch(d.nodeName) {
                case "Survey":
                  a.surveyURL = X(d);
        ...
        case "Wrapper":
          if(b = c) {
            for(a = new xc, a.beacons = new Fc, b = H(b), c = 0;c < b.length;c++) {
                      ...
                      case "MediaFiles":
                        ...
                        if(l) {
                          for(r.mediaFiles = [], l = H(l), I = 0;I < l.length;I++) {
                            var E = l[I];
                            "MediaFile" == E.nodeName && (y = new zc, y.bitrate = E.getAttribute("bitrate"), y.delivery = E.getAttribute("delivery"), y.width = E.getAttribute("width"), y.height = E.getAttribute("height"), y.type = E.getAttribute("type"), y.apiFramework = E.getAttribute("apiFramework"), (E = X(E)) && (y.url = E), 0 === y.url.indexOf("http") && r.mediaFiles.push(y))
                          }
                        }
                        break;
                      case "AdParameters":
                ...
                if(k = H(k)) {
                  for(f.O = [], s = 0;s < k.length;s++) {
                    if("Companion" == k[s].nodeName && (r = k[s], p = f.O, r)) {
                      n = new Hc;
                      n.beacons = new Fc;
                      n.companionSize = new Gc(parseInt(r.getAttribute("width"), 10), parseInt(r.getAttribute("height"), 10));
                      r = H(r);
...
;var Ed = new Q(411, "Invalid Ad tag response!"), Fd = new Q(412, "The video format is not playable!"), Gd = new Q(413, "Too many VAST wrappers to request!"), Hd = new Q(560, "No more ads or no failover!");
function Y() {
  this.c = [];
  this.U = [];
  this.aa = this.Da = !1;
  this.f = Vc("adaptv.vpaid.AdSource")
}
Y.prototype.init = function(a, b, c) {
  ...
  this.Ea = b;
  this.s = 0;
  a = new vd(this.M, 0, 1E4);
  Ob(a, ["done", "error"], function(a) {
    Id(this, a.data, a.type)
  }, !1, this);
  a.ka()
};
  ...
  if(b && b.i && b.i.length && "error" !== c) {
    if(a.c = b.i[0], a.Da = b.X, a.Da) {
      for(c = 0;c < a.c.length;c++) {
        a.U.push(new uc(a.c[c], a.Ea))
      }
    }else {
      a.U.push(new uc(a.c[0], a.Ea))
    }
  }
...
Y.prototype.ea = function() {
  if(this.s < this.c.length) {
    var a = this.U[this.s];
    this.aa || (A(Bc(a.l, R.Ka), function(a) {
      a = db(mb, {url:a});
      document.body.appendChild(a)
    }), this.aa = !0);
    if(a && null !== (Ec(a.l) instanceof wc ? Ec(a.l) : null)) {
      var b = Jd(this, a);
      0 === b.error.errorCode ? (this.ra(b), this.aa = !1, this.s++) : Z(this, b.error)
    }else {
      a.depth > a.l.size() ? (b = Ec(a.l), b = new vd(b ? b.na : "", a.depth, 1E4), Ob(b, ["done", "error"], function(b) {
        var d = b.data;
        if(d && d.i && d.i.length) {
...
function Z(a, b) {
  ...
  a.s < a.U.length && A(Bc(a.U[a.s].l, R.pa), function(a) {
    a = db(mb, {url:a});
    document.body.appendChild(a)
  });
  a.aa = !1;
...
function Jd(a, b) {
  var c = Ec(b.l) instanceof wc ? Ec(b.l) : null, d = new Ac, e = c.d && c.d.length ? c.d[0].mediaFiles : [];
  if(e && e.length) {
    for(var f = 0;f < e.length;f++) {
      if("application/x-shockwave-flash" === e[f].type && ("undefined" != typeof navigator.plugins && "object" == typeof navigator.plugins["Shockwave Flash"] || window.ActiveXObject && "object" == typeof new ActiveXObject("ShockwaveFlash.ShockwaveFlash"))) {
        d.mediaFiles = [e[f]];
        d.isVPAID = !0;
        break
      }
...
;w("__adaptv__.debug.configure", function(a, b) {
  Vc(a).Ha(b || Qc);
  var c = new Pd;
  !0 != c.Qa && (Uc(), Tc.qa(c.Db), c.Qa = !0)
});
w("__adaptv__.debug.log", function(a) {
  Vc("adaptv.page").info(a)
});
